...
// The TelegramBlobFunc type is an adapter to allow the use of ordinary
// function as TelegramBlob mutator.
type TelegramBlobFunc func(context.Context, *ent.TelegramBlobMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f TelegramBlobFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.TelegramBlobMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.TelegramBlobMutation", m)
}
